//
//  DisplayNode+InterfaceState.swift
//  SwiftDisplay
//
...
public struct InterfaceState: OptionSet {
  ...
  public static let visible = InterfaceState(rawValue: 1 << 3)
   ...
   */
  public static let inHierarchy: InterfaceState = [.measureLayout, .preload, .display, .visible]
...
public protocol InterfaceStateDelegate: AnyObject {
   ...
   */
  func interfaceStateDidChange(from oldState: InterfaceState, to newState: InterfaceState)
